...
#define EI_CLASSIFIER_PROJECT_ID                 486756
#define EI_CLASSIFIER_PROJECT_OWNER              "KacperS"
#define EI_CLASSIFIER_PROJECT_NAME               "Magisterka"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "roll-state + pitch-state + a-state + yaw-state"
