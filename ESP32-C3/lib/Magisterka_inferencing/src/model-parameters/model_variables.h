...
const char* ei_classifier_inferencing_categories[] = { "kolo", "machanie", "nadgarstek", "piesc", "przesuniecie" };

uint8_t ei_dsp_config_135_axes[] = { 0, 1, 3, 2 };
const uint32_t ei_dsp_config_135_axes_size = 4;
ei_dsp_config_raw_t ei_dsp_config_135 = {
    135, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 135
        ...
        (void*)&ei_dsp_config_135, // pointer to config struct
        ei_dsp_config_135_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_135_axes_size, // number of axes
        1, // version
...
const uint32_t ei_learning_block_5_inputs[1] = { 135 };
...
const ei_impulse_t impulse_486756_0 = {
    .project_id = 486756,
    .project_owner = "KacperS",
    ...
    .fusion_string = "roll-state + pitch-state + a-state + yaw-state",
    .slice_size = (5/4),
...
ei_impulse_handle_t impulse_handle_486756_0 = ei_impulse_handle_t( &impulse_486756_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_486756_0;
