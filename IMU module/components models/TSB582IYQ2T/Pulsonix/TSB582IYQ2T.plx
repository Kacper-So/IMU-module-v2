...
(library Library_1
	...
	(compDef "TSB582IYQ2T" (originalName "TSB582IYQ2T") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "IN2-") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/tsb582.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "TSB582IYQ2T.stp")
