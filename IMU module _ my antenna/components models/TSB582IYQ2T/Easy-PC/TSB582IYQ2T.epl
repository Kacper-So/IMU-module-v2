SamacSys ECAD Model
16500950/901297/2.50/9/2/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SON65P300X300X80-9N-D" (originalName "SON65P300X300X80-9N-D")
		(multiLayer
	...
	(symbolDef "TSB582IYQ2T" (originalName "TSB582IYQ2T")
	...
	(compDef "TSB582IYQ2T" (originalName "TSB582IYQ2T") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "OUT2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "IN2-") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "IN2+") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TSB582IYQ2T"))
		(attachedPattern (patternNum 1) (patternName "SON65P300X300X80-9N-D")
			(numPads 9)
			(padPinMap
		...
		(attr "Mouser Part Number" "511-TSB582IYQ2T")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/TSB582IYQ2T?qs=Znm5pLBrcAKk3VhMkCWftg%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "TSB582IYQ2T")
		(attr "Description" "High output current with thermal shutdown and output current limiter, 3.1 MHz, 36 V, BiCMOS dual operational amplifier")
		(attr "Datasheet Link" "https://www.st.com/resource/en/datasheet/tsb582.pdf")
		(attr "Height" "0.8 mm")
	)
